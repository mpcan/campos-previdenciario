...
export default function JurisprudenciaPage() {
  ...
  const [statusConexao, setStatusConexao] = useState(navigator.onLine);
        ...
        <div>
          ...
          {favoritosFiltrados.length > 0 ? (
              ...
              {favoritosFiltrados.map((favorito) => (
                <div key={favorito.id} className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  {favorito.ementa && (
                    <div className="mb-4">
                      <h4 className="font-medium text-gray-700 mb-1">Ementa:</h4>
                      <p className="text-gray-600 text-sm">{favorito.ementa}</p>
                    </div>
                  )}
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg font-medium text-gray-700 mb-2">Nenhum favorito encontrado</h3>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-xl font-semibold text-gray-800">Anotações</h2>
                <button
              ...
              <div className="mb-4">
                <h3 className="font-medium text-gray-700">{jurisprudenciaSelecionada.titulo}</h3>
                <p className="text-sm text-gray-500 mt-1">
                  {jurisprudenciaSelecionada.fonte.toUpperCase()} | {jurisprudenciaSelecionada.dataJulgamento || 'Data não informada'}
                </p>
              </div>
              ...
              {jurisprudenciaSelecionada.anotacoes?.length > 0 ? (
                <div className="mb-6">
                  <h4 className="font-medium text-gray-700 mb-2">Anotações existentes:</h4>
                ...
                <p className="mb-6 text-gray-500">Nenhuma anotação para esta jurisprudência.</p>
              )}
              
              {/* Formulário para nova anotação */}
              <div>
                <label htmlFor="nova-anotacao" className="block text-gray-700 font-medium mb-2">
                  Nova anotação
                </label>
                <textarea
                  id="nova-anotacao"
